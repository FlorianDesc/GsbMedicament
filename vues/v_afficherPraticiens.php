        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                <div class="formulaire">
                    <p><span class="carac">Num praticien</span> : <?php echo $carac[0] ?></p>
                    ...
                    <p><span class="carac">Coefficient notoriété</span> : <?php echo $carac[6] ?></p>
                    <p><span class="carac">Coefficient de confiance</span> : <?php echo empty($carac[7])? "Non défini(e)" : $carac[7] ?></p>
                    <p><span class="carac">Spécialité</span> : <?php echo $carac[8] ?></p>
                    <p><span class="carac">Lieu de travail</span> : <?php echo $carac[9] ?></p>
