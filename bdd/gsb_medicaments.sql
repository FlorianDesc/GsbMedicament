...
--
-- Base de données : `gsb_medicaments`
--
...
('t60', 'Tusseau', 'Josselin', '63 r Bon Repos', '28000', 'CHARTRES', '1991-03-29 00:00:00', NULL, '3', 'CE'),
...
CREATE TABLE IF NOT EXISTS `rapport_visite` (
  ...
  `MED_DEPOTLEGAL_Presente3` varchar(10) DEFAULT NULL,
  ...
  KEY `MED_DEPOTLEGAL_Presente3` (`MED_DEPOTLEGAL_Presente3`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
ALTER TABLE `rapport_visite`
  ...
  ADD CONSTRAINT `MED_DEPOTLEGAL_Presente3` FOREIGN KEY (`MED_DEPOTLEGAL_Presente3`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
